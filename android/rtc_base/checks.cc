...
RTC_NORETURN void rtc_FatalMessage(const char* file,
                                   ...
                                   const char* msg) {
#if RTC_CHECK_MSG_ENABLED
  static constexpr rtc::WEBRTC_NAMESAPCE(_checks_impl)::CheckArgType t[] = {
      rtc::WEBRTC_NAMESAPCE(_checks_impl)::CheckArgType::kEnd};
  rtc::WEBRTC_NAMESAPCE(_checks_impl)::FatalLog(file, line, msg, t);
#else
  rtc::WEBRTC_NAMESAPCE(_checks_impl)::FatalLog(file, line);
#endif
}
