...
class RefCountedObject : public T {
 ...
 protected:
  ...
  mutable WEBRTC_NAMESAPCE::WEBRTC_NAMESAPCE(_impl)::RefCounter ref_count_{0};
...
class FinalRefCountedObject final : public T {
 ...
 private:
  ...
  class ZeroBasedRefCounter : public WEBRTC_NAMESAPCE::WEBRTC_NAMESAPCE(_impl)::RefCounter {
   public:
