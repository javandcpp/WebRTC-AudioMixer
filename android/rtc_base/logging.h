...
namespace WEBRTC_NAMESAPCE(_logging_impl) {
...
#define RTC_LOG_FILE_LINE(sev, file, line)        \
  ::rtc::WEBRTC_NAMESAPCE(_logging_impl)::LogCall() &         \
      ::rtc::WEBRTC_NAMESAPCE(_logging_impl)::LogStreamer<>() \
          << ::rtc::WEBRTC_NAMESAPCE(_logging_impl)::LogMetadata(file, line, sev)
...
#define RTC_LOG_E(sev, ctx, err)                                 \
  !rtc::LogMessage::IsNoop<::rtc::sev>() &&                      \
      ::rtc::WEBRTC_NAMESAPCE(_logging_impl)::LogCall() &                    \
          ::rtc::WEBRTC_NAMESAPCE(_logging_impl)::LogStreamer<>()            \
              << ::rtc::WEBRTC_NAMESAPCE(_logging_impl)::LogMetadataErr {    \
...
#define RTC_LOG_TAG(sev, tag)                                 \
  !rtc::LogMessage::IsNoop(sev) &&                            \
      ::rtc::WEBRTC_NAMESAPCE(_logging_impl)::LogCall() &                 \
          ::rtc::WEBRTC_NAMESAPCE(_logging_impl)::LogStreamer<>()         \
              << ::rtc::WEBRTC_NAMESAPCE(_logging_impl)::LogMetadataTag { \
    sev, ::rtc::WEBRTC_NAMESAPCE(_logging_impl)::AdaptString(tag)         \
  }
...
#define RTC_DLOG_EAT_STREAM_PARAMS()                \
  while (false)                                     \
  ::rtc::WEBRTC_NAMESAPCE(_logging_impl)::LogMessageVoidify() & \
      (::rtc::WEBRTC_NAMESAPCE(_logging_impl)::LogStreamer<>())
