...
#else
#define EXPECT_METRIC_EQ(val1, val2) WEBRTC_NAMESAPCE::metrics_impl::NoOp(val1, val2)
#define EXPECT_METRIC_EQ_WAIT(val1, val2, timeout) WEBRTC_NAMESAPCE::metrics_impl::NoOp(val1, val2, timeout)
#define EXPECT_METRIC_GT(val1, val2) WEBRTC_NAMESAPCE::metrics_impl::NoOp(val1, val2)
#define EXPECT_METRIC_LE(val1, val2) WEBRTC_NAMESAPCE::metrics_impl::NoOp(val1, val2)
#define EXPECT_METRIC_TRUE(condition) WEBRTC_NAMESAPCE::metrics_impl::NoOp(condition || true)
#define EXPECT_METRIC_FALSE(condition) WEBRTC_NAMESAPCE::metrics_impl::NoOp(condition && false)
#define EXPECT_METRIC_THAT(value, matcher) WEBRTC_NAMESAPCE::metrics_impl::NoOp(value, testing::_)
#endif
...
//    Histogram* WEBRTC_NAMESAPCE::metrics::HistogramFactoryGetCounts(
//        const std::string& name, int sample, int min, int max,
//        int bucket_count);
//    Histogram* WEBRTC_NAMESAPCE::metrics::HistogramFactoryGetEnumeration(
//        const std::string& name, int sample, int boundary);
//    void WEBRTC_NAMESAPCE::metrics::HistogramAdd(
...
#define RTC_HISTOGRAM_COUNTS(name, sample, min, max, bucket_count)       \
  RTC_HISTOGRAM_COMMON_BLOCK(name, sample,                               \
                             WEBRTC_NAMESAPCE::metrics::HistogramFactoryGetCounts( \
                                 name, min, max, bucket_count))

#define RTC_HISTOGRAM_COUNTS_LINEAR(name, sample, min, max, bucket_count)      \
  RTC_HISTOGRAM_COMMON_BLOCK(name, sample,                                     \
                             WEBRTC_NAMESAPCE::metrics::HistogramFactoryGetCountsLinear( \
                                 name, min, max, bucket_count))
...
#define RTC_HISTOGRAM_ENUMERATION_SPARSE(name, sample, boundary) \
  RTC_HISTOGRAM_COMMON_BLOCK_SLOW(                               \
      name, sample,                                              \
      WEBRTC_NAMESAPCE::metrics::SparseHistogramFactoryGetEnumeration(name, boundary))
...
#define RTC_HISTOGRAM_ENUMERATION(name, sample, boundary) \
  RTC_HISTOGRAM_COMMON_BLOCK_SLOW(                        \
      name, sample,                                       \
      WEBRTC_NAMESAPCE::metrics::HistogramFactoryGetEnumeration(name, boundary))
...
#define RTC_HISTOGRAM_COMMON_BLOCK(constant_name, sample,                  \
  ...
  do {                                                                     \
    ...
    if (histogram_pointer) {                                               \
      WEBRTC_NAMESAPCE::metrics::HistogramAdd(histogram_pointer, sample);            \
    }                                                                      \
  } while (0)
...
#define RTC_HISTOGRAM_COMMON_BLOCK_SLOW(name, sample, factory_get_invocation) \
  do {                                                                        \
    WEBRTC_NAMESAPCE::metrics::Histogram* histogram_pointer = factory_get_invocation;   \
    if (histogram_pointer) {                                                  \
      WEBRTC_NAMESAPCE::metrics::HistogramAdd(histogram_pointer, sample);               \
    }                                                                         \
  } while (0)
...
#define RTC_HISTOGRAM_COUNTS_100(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_COUNTS_200(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_COUNTS_500(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_COUNTS_1000(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_COUNTS_10000(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_COUNTS_100000(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_COUNTS(name, sample, min, max, bucket_count) \
  WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample, min, max, bucket_count)

#define RTC_HISTOGRAM_COUNTS_LINEAR(name, sample, min, max, bucket_count) \
  WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample, min, max, bucket_count)

#define RTC_HISTOGRAM_COUNTS_SPARSE_100(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_COUNTS_SPARSE_200(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_COUNTS_SPARSE_500(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_COUNTS_SPARSE_1000(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_COUNTS_SPARSE_10000(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_COUNTS_SPARSE_100000(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_COUNTS_SPARSE(name, sample, min, max, bucket_count) \
  WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample, min, max, bucket_count)

#define RTC_HISTOGRAM_PERCENTAGE_SPARSE(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_BOOLEAN_SPARSE(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_ENUMERATION_SPARSE(name, sample, boundary) \
  WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample, boundary)

#define RTC_HISTOGRAM_PERCENTAGE(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)

#define RTC_HISTOGRAM_BOOLEAN(name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample)
...
#define RTC_HISTOGRAM_COMMON_BLOCK(constant_name, sample,  \
                                   factory_get_invocation) \
  WEBRTC_NAMESAPCE::metrics_impl::NoOp(constant_name, sample, factory_get_invocation)

#define RTC_HISTOGRAM_COMMON_BLOCK_SLOW(name, sample, factory_get_invocation) \
  WEBRTC_NAMESAPCE::metrics_impl::NoOp(name, sample, factory_get_invocation)

#define RTC_HISTOGRAMS_COUNTS_100(index, name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(index, name, sample)

#define RTC_HISTOGRAMS_COUNTS_200(index, name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(index, name, sample)

#define RTC_HISTOGRAMS_COUNTS_500(index, name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(index, name, sample)

#define RTC_HISTOGRAMS_COUNTS_1000(index, name, sample) \
  WEBRTC_NAMESAPCE::metrics_impl::NoOp(index, name, sample)
...
#define RTC_HISTOGRAMS_ENUMERATION(index, name, sample, boundary) \
  WEBRTC_NAMESAPCE::metrics_impl::NoOp(index, name, sample, boundary)

#define RTC_HISTOGRAMS_PERCENTAGE(index, name, sample) WEBRTC_NAMESAPCE::metrics_impl::NoOp(index, name, sample)

#define RTC_HISTOGRAMS_COMMON(index, name, sample, macro_invocation) \
  WEBRTC_NAMESAPCE::metrics_impl::NoOp(index, name, sample, macro_invocation)
