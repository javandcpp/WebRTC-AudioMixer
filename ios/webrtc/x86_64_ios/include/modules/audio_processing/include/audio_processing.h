...
class RTC_EXPORT AudioProcessing : public ksrtc::RefCountInterface {
 public:
  ...
  struct RTC_EXPORT Config {
    ...
    // Enables reporting of |voice_detected| in WEBRTC_NAMESAPCE::AudioProcessingStats.
    ...
    // Enables reporting of |output_rms_dbfs| in WEBRTC_NAMESAPCE::AudioProcessingStats.
  ...
  // Creates and attaches an WEBRTC_NAMESAPCE::AecDump for recording debugging
  // information.
...
class RTC_EXPORT AudioProcessingBuilder {
 public:
  ...
  AudioProcessing* Create(const WEBRTC_NAMESAPCE::Config& config);
