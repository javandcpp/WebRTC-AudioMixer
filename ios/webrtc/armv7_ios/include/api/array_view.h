...
// tl;dr: ksrtc::ArrayView is the same thing as gsl::span from the Guideline
//        Support Library.
//
...
// std::vector, ksrtc::Buffer, ...), but it's error-prone because the caller has
...
//
// Enter ksrtc::ArrayView<T>. It contains a T pointer (to an array it doesn't
// own) and a count, and supports the basic things you'd expect, such as
// indexing and iteration. It allows us to write our function like this:
//
//   bool Contains17(ksrtc::ArrayView<const int> arr) {
//     for (auto e : arr) {
//       if (e == 17)
//         return true;
//     }
...
//   Contains17(ksrtc::ArrayView<int>(arr, size));  // pointer + size
...
class ArrayView final : public impl::ArrayViewBase<T, Size> {
 public:
  ...
  // ksrtc::Buffer to ArrayView<uint8_t> or ArrayView<const uint8_t>, and
  // const ksrtc::Buffer to ArrayView<const uint8_t>.
  template <
      typename U,
      typename std::enable_if<Size == impl::kArrayViewVarSize &&
                              HasDataAndSize<U, T>::value>::type* = nullptr>
